...
<center>
  <label><H3 align = "center">Nestle Shipment</H3></label>
<br>
...
<!-- Commenting out the Intended location part, because we already expect it to be Nestle and its Item ID. -->
<!-- <p>
...
<?php
  if(isset($_POST['create'])){
    ...
    if(empty($myitemID) || empty($myitem) || empty($regionName) || empty($myhub) || empty($myquantity) || empty($mybatchcode) || empty($mypersonnelName) || empty($myunitofmeasure) || empty($myunit) || empty($myemail) || empty($mydestination)){
?>
...
<?php
      ...
      ('$mywaybillId','$myitem','$myitemID','$myregion[1]','$mystaff[1]','N/A','C-1000000000000001','$myquantity','$myunit','$mybatchcode','$myunitofmeasure','$myemail','$mydate','$mypersonnelName','$mystatus', '$myhub', 'Shipment to Nestle')";
