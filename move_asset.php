...
<section class="content">
                                        ...
                                        <fieldset>
                                            ...
                                            <p>
                                                ...
                                                <datalist id="descriptordrop">
                                                    ...
                                                    while ($descrow = $descsql->fetch_assoc()) {
                                                        ?>
                                                        <option value="<?php echo $descrow['item_description']; ?>"><?php echo $descrow['item_description']; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </datalist>
    ...
    <div class="footer">
        ...
        if (isset($_POST['create'])) {
            ...
            $mysync = 'no';
            if (
                empty($_POST['itemIDlist']) || empty($_POST['itemlist']) || empty($_POST['confirmlist']) ||
            ...
            <?php
                ...
                ?>
                <script type="text/javascript">
                    swal.fire("Error", "Both Item names must be the same", "error");
                </script>
            <?php
            } else {
                $asset_insert = "INSERT INTO asset_transactions(itemid, itemname, itemdescription, location_out, location_in, unit, quantity, procurement_officer, username, status, date, comments) VALUES ('$myitemID','$myitem','$mydescription','$myregion','$mydestination','$myunit','$myquantity','$mysdpersonnel','" . $_SESSION['login_user'] . "','In Progress','$mydate','$mycomment')";
                $result_insert = mysqli_query($db_con, $asset_insert);
                if ($result_insert) {
                    ?>
                    <script type="text/javascript">
                        swal.fire("Yes", "Movement has been initiated", "success");
                    </script>
                <?php
                }
            }
