...
<H4 align = "center">Welcome <?php echo $_SESSION['login_user']?></H4>
       <!-- <h3>THe session level: <?php echo $_SESSION['sessionlevel']?></h3> -->
        ...
        Enter ItemID<input type="text" list="productdrop" name = "itemIDlist" id="itemIDlist" autocomplete="off" placeholder="Enter Item ID" class="box"/>
                    ...
                    <p>
    Enter Warehouse Out<input type="text" list="regiondrop" name = "regionlist" id="regionlist" autocomplete="off" placeholder="Enter Warehouse Name to get Item" onchange = "validatewarehouse(this.value);" class="box"/> <a id="warehouse_error" style="color:red;"></a>
    ...
    Enter Unit to take out <input type="text" name="quantitylist" id="quantitylist" placeholder="Enter Item Unit" onchange="validateunit();" class="box"/> <a id="unit_error" style="color:red;"></a> <br>
    ...
    Confirm Unit Again <input type="text" name="quantityconfirmlist" id="quantityconfirmlist" placeholder="Enter Item Unit" onchange="validateunit();" class="box"/> <br>
        ...
        <input type = "submit" name = 'create' value = "Create Conversion Shipment" /><br/>
...
function validatewarehouse(warehousename){
    ...
    var warehousevalue = document.getElementById('regionlist').value;
...
<?php
    ...
    if(isset($_POST['create'])){
        ...
        $mydestination = /*mysqli_real_escape_string($db_con,$_POST['destinationlist'])*/'Conversion Out';
        ...
        if(empty($_POST['itemIDlist']) || empty($_POST['itemlist']) || empty($_POST['confirmlist']) || empty($_POST['regionlist'])  /* || empty($_POST['customerlist'])*/ || empty($_POST['unitlist']) || empty($_POST['quantitylist'])){
        ...
        <?php   
            ...
            $sql_insert = "INSERT INTO web_transactions (transactionID,itemId,item,region,destination,unit,quantity,date,personnelName,status,sdstatus,sdpersonnel,pcstatus,transaction_type,comments,sync) VALUES ('$uniqueID','$myitemID','$myitem','$myregion','$mydestination','$myunit','$myquantity','$mydate','".$_SESSION['login_user']."','$mystatus','pending','$mysdpersonnel','pending','Conversion OUT','$mycomment','$mysync')";
        ...
        if($result_insert){
            ...
            $from = "Inventory";
            $text = "CONVERT OUT,".$uniqueID.",".$myregion.",".$mydestination.",".$myitem.",".$myquantity.",".$myunit;
            ...
            $pc_curl = curl_init();
            $from = "Inventory";
            $text = "Conversion Out".$uniqueID.",".$myregion.",".$mydestination.",".$myitem.",".$myquantity.",".$myunit;
    ...
    <script type="text/javascript">
      window.alert("Transaction has been successfully created");
    </script>
