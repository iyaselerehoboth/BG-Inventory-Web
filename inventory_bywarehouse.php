...
<?php
    ...
    if(isset($_POST['search'])){
        ...
        echo "Total amount of Items available in <b>" .$searchrow['warehouse_name']. "</b> is :" .$searchrow['SUM(amount_available)'];
        ...
        while($row = mysqli_fetch_array($run_fetch)){
            ...
            print("<br>");
            print "item Available:  <b>" .$row['item'].  "</b>   Warehouse:  <b>" .$row['warehouse_name']. "</b>   Quantity:   <b>" .($row['amount_available'])." ".($row['unit_available'])."</b>"; 
    }
  }
}
?>
