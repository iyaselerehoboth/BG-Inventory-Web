...
<section class="content-header">
  ...
  <a href="convert_transaction_in.php">Conversion IN</a>
    ...
    Enter Warehouse Out<input type="text" list="regiondrop" name = "regionlist" id="regionlist" autocomplete="off" placeholder="Enter Warehouse to move from" class="box"/>
                    ...
                    <p>
    Enter Warehouse In<input type="text" list="destinationdrop" name = "destinationlist" id="destinationlist" placeholder="Enter Warehouse to receive Item" onchange = "validatewarehouse(this.value);" class="box"/> <a id="warehouse_error" style="color:red;"></a>
