...
<form action = "" method = "post">
    ...
    <B>TO:</B>
    <textarea class="form-control" id="addressTo" name="addressTo" rows="5"></textarea>
    <br>
	</div>
    ...
    <div style="float: left; width: 300px;"> 
    Enter Deductions <input type="text" name="deductions" id="deductions" placeholder= "Enter Deductions" value="0.00" class="box"/> <br>
    </div>                    

    <div style="float: right; width: 300px;">            
    Enter Deduction Type <input type="text" name="type_deductions" id="type_deductions" placeholder="Enter Deduction Type" value="" class="box"/> <br>
    </div>
    ...
    Enter Any Other Deductions <input type="text" name="other_deductions" id="other_deductions" value="0.00" placeholder="Enter Any Other Deductions" class="box"/> <br>
    </div>
...
<?php
	...
	if(isset($_POST['generate'])){
        ...
        $mydeductions = mysqli_real_escape_string($db_con, $_POST['deductions']);
        $mytype_deductions = mysqli_real_escape_string($db_con, $_POST['type_deductions']);
        $myother_deductions = mysqli_real_escape_string($db_con, $_POST['other_deductions']);
