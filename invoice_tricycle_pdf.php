...
$pdf->SetXY(-60,92);
$pdf->Cell(50,4,'Tricycle sale',0,2,'R',0);
...
$pdf->Cell(40,8,'Description',1,0,'C',0);
$pdf->Cell(30,8,'Waybill No',1,0,'C',0);
$pdf->Cell(30,8,'Quantity Delivered',1,0,'C',0);
//$pdf->SetXY(148,120);
...
$pdf->Cell(40,10,$viewrun['description'],1,0,'C',0);
$pdf->MultiCell(30,5,$viewrun['waybillNo'],1,'C',false);
$pdf->SetXY(113,128);
$pdf->Cell(30,10,$viewrun['QtyDelivered'].'Tricycles',1,0,'C',0);
...
$pdf->SetY(155);
$pdf->SetFont('Helvetica', 'B',8);
$pdf->Cell(70,4,'Product Type: '.$viewrun['productType'],0,2);
$pdf->Cell(70,4,'ENGINE MODEL: '.$viewrun['engineModel'],0,2);
$pdf->Cell(70,4,'ENGINE NUMBER: '.$viewrun['engineNo'],0,2);
$pdf->Cell(70,4,'CHASSIS NUMBERS: '.$viewrun['chassisNo'],0,2);
$pdf->Cell(70,4,'FACTORY NUMBER: '.$viewrun['factoryNumber'],0,2);
$pdf->Cell(70,4,'MANUFACTURE Date: '.$viewrun['manufactureDate'],0,2);
$pdf->Cell(70,4,'COLOR: '.$viewrun['color'],0,2);

$pdf->Cell(70,5,'',0,2);

$pdf->SetFont('Helvetica', '', 8);
$pdf->Cell(70,4,'Cheque(s) should be written in favor: ',0,2);
$pdf->SetFont('Helvetica', 'B');
$pdf->Cell(70,4,'Babban Gona Farmer Services Ltd.',0,2);
$pdf->SetFont('Helvetica', '');
...
$pdf->SetFont('Helvetica', '');
$pdf->Cell(20,4,'Guaranty Trust Bank',0,1);
...
$pdf->SetFont('Helvetica', '');
$pdf->Cell(20,4,'54, Awolow Road, Ikoyi',0,1);
...
$pdf->SetFont('Helvetica', '');
$pdf->Cell(20,4,'0124524591',0,1);

$pdf->SetY(230);
$pdf->SetFont('Helvetica', 'B');
$pdf->Cell(30,4,'For questions contact:', 0,1);
$pdf->SetFont('Helvetica', '');
$pdf->Cell(30,4,'Haro Baka',0,1);
$pdf->Cell(30,4,'0806-708-6878',0,1);
$pdf->Cell(30,4,'haro.baka@doreopartners.com',0,1);
