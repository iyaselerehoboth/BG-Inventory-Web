...
$pdf->SetXY(-60,92);
$pdf->Cell(50,4,'Motorcycle sale',0,2,'R',0);
...
//$pdf->SetXY(148,120);
$pdf->Cell(25,8,'Price per Bike',1,0,'C');
...
$pdf->MultiCell(40,10,$viewrun['description'],1,'C',false);
$pdf->SetXY(83,128);
$pdf->MultiCell(30,5,$viewrun['waybillNo'],1,'C',false);
$pdf->SetXY(113,128);
$pdf->Cell(30,10,$viewrun['QtyDelivered'].' Bikes',1,0,'C',0);
...
$pdf->SetY(155);
$pdf->SetFont('Helvetica', 'B',8);
$pdf->Cell(70,4, 'Member Making Request: ',0,2);
//$pdf->Cell(70,4,'ENGINE MODEL:',0,2);
$pdf->Cell(70,4,'ENGINE Number: '.$viewrun['engineNo'],0,2);
$pdf->Cell(70,4,'CHASSIS Number: '.$viewrun['chassisNo'],0,2);
//$pdf->Cell(70,4,'FACTORY NUMBER: ',0,2);
//$pdf->Cell(70,4,'MANUFACTURE Date: BG TR0001',0,2);
//$pdf->Cell(70,4,'COLOR: Red ',0,2);
...
$pdf->SetFont('Helvetica', '');
$pdf->Cell(30,4,'Oshone Anavhe',0,1);
$pdf->Cell(30,4,'0803-774-3782',0,1);
$pdf->Cell(30,4,'Oshone.anavhe@doreopartners.com',0,1);
