...
$pdf->SetXY(10,92);
$pdf->Cell(50,4,'Nestle Nigeria Plc,',0,1,'L',0);
$pdf->Cell(50,4,'Finance Deparment',0,1,'L',0);
$pdf->Cell(50,4,'22-24, Industrial Avenue',0,1,'L',0);
$pdf->Cell(50,4,'PMB 21164, Ikeja, 100253',0,1,'L',0);
$pdf->Cell(50,4,'Ilupeju, Lagos, Nigeria',0,1,'L',0);
$pdf->SetXY(-60,92);
$pdf->Cell(50,4,$viewrun['for_details'],0,2,'R',0);
$pdf->Cell(50,4,'Purchase order: '.$viewrun['purchaseOrder'],0,2,'R',0);
$pdf->Cell(50,4,'Purchase Order Date: '.$viewrun['purchaseOrderDate'],0,2,'R',0);
$pdf->Cell(50,4,'Vendor Number: 101117300',0,2,'R',0);
$pdf->Cell(50,4,'Nestle Material Number: 41192510',0,2,'R',0);
$pdf->Cell(50,4,'Vendor Site City: Zaria, Kaduna',0,1,'R',0);
...
$pdf->Cell(38,8,'Description',1,0,'C',0);
...
/*$pdf->Cell(25,10,'Offloading Fee:',1,2,'C',0);
$pdf->Cell(25,10,'Amount Payable:',1,2,'C',0);
$pdf->Cell(25,10,'Other Costs:',1,2,'C',0);
$pdf->Cell(25,10,'Balance Payment',1,0,'C',0);
$pdf->SetXY(-37,118);
$pdf->Cell(25,10,'',1,2,'C',0);
$pdf->Cell(25,10,'',1,2,'C',0);
$pdf->Cell(25,10,'',1,2,'C',0);
$pdf->Cell(25,10,'',1,2,'C',0);
...
$pdf->SetFont('Helvetica', '');
$pdf->Cell(20,4,'54, Awolowo road, Ikoyi, Lagos State.',0,1);
...
$pdf->Cell(30,4,'0708-994-5213',0,1);
