...
$pdf->SetTitle('Internal Transfer Waybill');
...
$pdf->SetX(-50);
$pdf->Cell(50,3,$viewrun['waybill_id'],0,2,'C');
$pdf->Cell(50,3,'SHIPMENT DATE: 02-07-18',0,1,'C');

$pdf->SetFont('Helvetica', 'B');
$pdf->Cell(50,3,'REQUESTED OUT BY: John Yohanna',0,1,'L');
...
$pdf->Cell(39,8,'COMMENTS',1,0,'L',0);



    $pdf->Cell(20,8,'','LR',1,'C',0);  // cell with left and right borders
